...
- Lint configuration with default branch setting
naming the branch the linter treats as the main branch of the repository
- Loading the default branch name from YAML file
